...
http://www.direct-netware.de/redirect.py?pas;subscription
...
:since:  v0.1.00
		...
		#
			...
			_return = NamedLoader.get_instance("dNG.pas.data.subscription.{0}Handler".format(handler), required, _id = _id)
